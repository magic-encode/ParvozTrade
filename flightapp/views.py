...
from flightapp.models.products import Products, Banner, BannerLefts, FeatureRights
...
def homeView(request):
    ...
    context: dict = { **dbctx, 'products': products, 'banners': banners, 'bannerleft': bannerleft, 'features': features}
